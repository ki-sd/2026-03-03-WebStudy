...
$((e)=>{
	const ws=new WebSocket("ws://"+window.location.host+"/JSPVueProject_3/news")
...
//			console.log(data)
			let html=""
			data.map(news=>{
				html+='<li><a href="'+news.link+'" target="_black">'+news.title+'</a></li>'
			})
			$('#newsList').html(html)
			...
			console.error("JSON파싱 실패:",err,event.data)
		}
	}
})
</script>
