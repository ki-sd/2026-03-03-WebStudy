									...
									<tr>
										...
										<td class="text-right">
											<c:if test="${rvo.id==sessionScope.id }">
												...
												<a href="../reply/delete.do?no=${rvo.no }&fno=${vo.fno}" class="btn btn-xs btn-info">삭제</a>
											</c:if>
										</td>
									</tr>
									<tr>
										...
										<td colspan="2">
											<table class="table">
												<form method="post" action="../reply/update.do">
													<tr>
														<td>
															<input type="hidden" name="bno" value="${vo.fno }">
															<input type="hidden" name="no" value="${rvo.no }">
															<textarea rows="4" cols="70" style="float: left" name="msg">${rvo.msg}</textarea>
															<button type="submit" class="btn-primary"
																style="width: 100px;height: 90px;float: left">댓글수정</button>
														</td>
													</tr>
												</form>
										</table>
					...
					<form method="post" action="../reply/insert.do">
						<tr>
							<td>
								...
								<button type="submit" class="btn-primary"
								style="width: 100px;height: 90px;float: left">댓글쓰기</button>
							</td>
						</tr>
					</form>
				</table>
