...
<body>
	<%--
		 디렉티브
		   ...
		   v-else
		   ===============
		   v-for : forEach형식이 디폴트 => 일반적인 for문 사용하려면 숫자를 배열로
		           *** v-for / v-if 동시 사용 불가능
	...
	<div class="container">
		<div class="row">
			...
			<button type="button" class="btn-sm btn-primary" @click="select(5)">분식</button>
		</div>
		...
		<div class="row text-center" style="margin-top: 10px">
			<button type="button" class="btn-lg btn-danger" @click="log()">로그인</button>
			<button type="button" class="btn-lg btn-primary" @click="logout()">로그아웃</button>
			<div v-if="login===true">
				<h3>로그인 되었습니다</h3>
			</div>
			<div v-else>
