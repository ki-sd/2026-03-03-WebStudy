...
import com.sist.service.TourService;
import com.sist.service.TourServiceImpl;
...
public class TourModel {
	...
	public String seoul_travel(HttpServletRequest request,HttpServletResponse response) {
		...
		List<TourVO> list=service.travelListData(map);
		int totalpage=service.travelTotalPage(map);
