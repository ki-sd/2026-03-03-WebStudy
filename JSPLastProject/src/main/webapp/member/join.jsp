			    ...
			    <div class="panel-body">
			     <form id="frm" name="frm" method="post" action="../member/join_ok.do">
			      <table class="table table-bordered table-hover">
			        <tr>
			          <th class="text-center" width="20%"><sup style="color:red">* </sup>ID</th>
			          <td>
			        ...
			        <tr>
			          <th class="text-center"><sup style="color:red">* </sup>Password</th>
			          <td>
			            <div class="form-inline">
			        ...
			        <tr>
			          <th class="text-center"><sup style="color:red">* </sup>이름</th>
			          <td><input type="text" name="name" id="name" class="form-control input-sm" placeholder="이름 입력" required></td>
			        </tr>
			
			        <tr>
			          <th class="text-center"><sup style="color:red">* </sup>성별</th>
			          <td>
			        ...
			        <tr>
			          <th class="text-center"><sup style="color:red">* </sup>생년월일</th>
