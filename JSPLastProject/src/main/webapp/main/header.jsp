                    ...
                    <div class="signup-search-area d-flex align-items-center justify-content-end">
                        <div class="login_register_area d-flex">
                        	<c:if test="${sessionScope.id==null }">
	                            <div class="login">
	                                <a class="link" id="login">log in</a>
	                            </div>
                            </c:if>
                            <c:if test="${sessionScope.id!=null }">
	                            <div class="logout">
	                            	<span>
	                            		<strong class="welcome">${sessionScope.name } (${sessionScope.admin=='y'?'관리자':'일반사용자' })님 환영합니다</strong>
	                            	</span>
	                                <a class="link" href="../member/logout.do" id="logout" style="margin-left: 5px">| log out</a>
	                            </div>
                            </c:if>
                        </div>
                        <!-- Search Button Area -->
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="logo_area text-center">
                        <a href="../main/main.do" class="yummy-logo" style="text-decoration: none">Travel</a>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <c:if test="${sessionScope.id!=null }">
	                                ...
	                                <c:if test="${sessionScope.admin=='y' }">
		                                <li class="nav-item">
		                                    <a class="nav-link" href="../adminpage/adminpage_main.do">관리자페이지</a>
		                                </li>
	                                </c:if>
                                </c:if>
                            </ul>
