                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post wow fadeInUp" data-wow-delay=".4s">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <img src="${bvo.firstimage }" alt="" onerror="this.src='../tour/no_image.png'">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                                        ...
                                        <div class="post-comment-share-area d-flex">
                                            <!-- Post Favourite -->
                                            <div class="post-favourite">
                                                <a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i> ${bvo.likecount }</a>
                                            </div>
                                            <!-- Post Comments -->
                                            <div class="post-comments">
                                                <a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i> ${bvo.replycount }</a>
                                            </div>
                                            <!-- Post Share -->
                                            <div class="post-share">
                                                <a href="#"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                                    ...
                                    <a href="#">
                                        <h4 class="post-headline">${bvo.title }</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-4">
                    <div class="blog-sidebar mt-5 mt-lg-0">
                        ...
                        <div class="single-widget-area about-me-widget text-center">
                            ...
                            <h4>전국 곳곳 비에 무더위 계속…낮 최고 32도[오늘날씨]</h4>
