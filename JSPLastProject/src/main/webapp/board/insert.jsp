            	...
            	<form method="post" action="../board/insert_ok.do">
	            	<table class="table">
	            		<tr>
	            			...
	            			<td width="85%">
	            				<input type="text" name=name size=20 class="input-sm" value="${sessionScope.name }" readonly>
	            			</td>
	            		</tr>
	            		<tr>
	            			<th class="text-center table-success" width="15%">제목</th>
	            			<td width="85%">
	            				<input type="text" name=subject size=60 class="input-sm" autofocus required>
	            			</td>
	            		</tr>
	            		<tr>
	            		...
	            		<tr>
	            			<td colspan="2" class="text-center">
	            				<button type=submit class="btn-sm btn-outline-primary">글쓰기</button>
	            				<button type=button class="btn-sm btn-outline-danger" onclick="javascript:history.back()">취소</button>
	            			</td>
	            		</tr>
	            	</table>
            	</form>
