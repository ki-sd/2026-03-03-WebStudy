...
$((e)=>{
	...
	$('.btns').on('click',(e)=>{
		...
		if(bCheck===false){
			bCheck=true
			$('#form'+no).show()
			$(e.currentTarget).val('취소')
		}else{
			bCheck=false
			$('#form'+no).hide()
			$(e.currentTarget).val('수정')
		}
            	...
            	<div class="col-12 col-lg-8">
            		<div class="row no-gutters">
            			<table class="table">
		            		...
		            		<tr>
		            			<th width="10%" style="color: gray">종류</th>
		            		...
		            		<tr>
		            			<td colspan="3" class="text-right">
		            				<c:if test="${sessionScope.id!=null }">
			            				<button class="btn-xs btn-danger">♥️ 좋아요</button>
		            	...
		            	<table class="table">
		            		<tr>
		            			<td>
		            				...
		            				<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=API키 입력&libraries=services"></script>
									<script>
			        			...
			        			<li class="review-card">
			        				...
			        				<c:if test="${sessionScope.id==rvo.id }">
			        					<div class="review-meta">
				        					<div><input type="button" class="btn-xs btn-outline-primary btns" value="수정" data-no="${rvo.no }"></div>
				        					<div><input type="button" class="btn-xs btn-outline-danger" value="삭제"
				        						onclick="location.href='../review/delete.do?no=${rvo.no}&fno=${rvo.fno }'"></div>
			        					</div>
			        				</c:if>
