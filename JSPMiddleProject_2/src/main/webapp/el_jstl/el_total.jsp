		...
		*** JSTL , EL => SpringFrameWork / Spring-Boot
		...
		3) EL
		   ...
		   = 내장 객체
		     ...
		     3. pageContext => 경로설정 (<link href=""> <a href="">)
		                              --------------------------
		                              React / Vue
		     ----------------
		     JSP 자체에서 사용
		     ...
		     자바 ======= JSP
		      |--- 전송 : request/session을 이용해서 데이터 전송
		                         | 여러개의 JSP에서 공통으로 사용 : Java의 static 변수
		                 | 한번 사용 (한개의 JSP) : Java의 인스턴스 변수
		      <%= %> => ${} : 단순화 , 자바코딩 제거
		               ---- 일반변수는 출력 불가
		      ----- 일반변수 / request / session
		      
		      => 화면 출력을 위해서 넘겨준 값만 출력 가능
		         -------------------- request / session
