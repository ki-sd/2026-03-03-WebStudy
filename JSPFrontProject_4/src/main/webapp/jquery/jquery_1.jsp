...
<script type="text/javascript" src="http://code.jquery.com/jquery.js"></script> <%-- 3.0 --%>
<%-- <script type="text/javascript" src="http://code.jquery.com/jquery-4.0.0.min.js"></script> 4.0 --%>
...
$(()=>{
	...
	*/
	...
	$('h2:eq(1)').css("color","cyan")
	$('h2:eq(2)').css("color","gold")
	$('h2:eq(3)').css("color","pink")
	$('h2:eq(4)').css("color","brown")
	
	/*
	let h3s=document.querySelectAll("h3")
	for(let h3 of h3s){
	...
	*/
	...
	// this => 자신 (이벤트 해당되는 태그)
	//      => Arrow 함수 이용시 상위스코프(보통 window)를 가르키게 됨. (e.currentTarget 이용)
	//         Arrow 함수는 This가 없기때문에 애로우함수 안의 애로우함수의 this도 window임
})
</script>
</head>
<body>
